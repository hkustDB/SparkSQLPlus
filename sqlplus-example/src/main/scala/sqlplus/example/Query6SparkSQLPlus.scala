...
object Query6SparkSQLPlus {
	...
	def main(args: Array[String]): Unit = {
		...
		val v24 = v23.enumerateWithOneComparison(v14, 1, 2, (x: Int, y: Int) => intLessThan(y, x), Array(0, 1), Array(1), (l, r) => (r(0).asInstanceOf[Int]))
		val v25 = v24.enumerateWithOneComparison(v9, 1, 2, (x: Int, y: Int) => intLessThan(y, x), Array(0, 1, 2), Array(0, 1, 2))
