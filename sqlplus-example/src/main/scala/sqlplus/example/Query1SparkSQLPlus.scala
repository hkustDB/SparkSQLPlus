...
object Query1SparkSQLPlus {
	...
	def main(args: Array[String]): Unit = {
		...
		val v25 = v24.enumerateWithOneComparison(v19, 0, 2, (x: Long, y: Long) => longLessThan(x, y), Array(0), Array(0), (l, r) => (r(1).asInstanceOf[Int]))
		val v26 = v25.enumerateWithOneComparison(v14, 0, 2, (x: Long, y: Long) => longLessThan(x, y), Array(0, 1), Array(0), (l, r) => (r(1).asInstanceOf[Int]))
		val v27 = v26.enumerateWithOneComparison(v9, 0, 2, (x: Long, y: Long) => longLessThan(x, y), Array(0, 1, 2), Array(0, 1, 2))
