...
object Query3SparkSQLPlus {
	...
	def main(args: Array[String]): Unit = {
		...
		val v18 = v17.groupBy()
		val v19 = v18.constructTreeLikeArray(3, 2, (x: Long, y: Long) => longLessThan(x, y), (x: Long, y: Long) => longLessThan(x, y))
		...
		val v24 = v23.appendExtraColumn(v20, 2, (x: Long, y: Long) => longLessThan(x, y))
		val v25 = v24.reKeyBy(x => x(1).asInstanceOf[Int])
		val v26 = v25.groupBy()
		val v27 = v26.sortValuesWith(3, (x: Long, y: Long) => longLessThan(x, y)).persist()
		...
		val v33 = v32.enumerateWithOneComparison(v27, 0, 3, (x: Long, y: Long) => longLessThan(y, x), Array(0), Array(1, 2), (l, r) => (r(0).asInstanceOf[Int]))
		val v34 = v33.enumerateWithTwoComparisons(v19, 2, 0, Array(0, 1, 2), Array(1, 3), (l, r) => (r(0).asInstanceOf[Int]))
		val v35 = v34.enumerateWithOneComparison(v11, 0, 2, (x: Long, y: Long) => longLessThan(y, x), Array(0, 1, 2, 3, 4), Array(0, 1, 2))
