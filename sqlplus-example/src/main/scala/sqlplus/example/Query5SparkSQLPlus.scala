...
object Query5SparkSQLPlus {
	...
	def main(args: Array[String]): Unit = {
		...
		val v16 = v15.groupBy()
		val v17 = v16.sortValuesWith[Long, Long, Long, Long](2, (x: Long, y: Long) => longLessThan(x, y)).persist()
		...
		val v23 = v22.groupBy()
		val v24 = v23.sortValuesWith[Long, Long, Long, Long](2, (x: Long, y: Long) => longLessThan(y, x)).persist()
