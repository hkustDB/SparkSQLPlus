...
case class CreateCommonExtraColumnAction(relationId: Int, extraColumnVariable: Variable, joinKeyIndices: List[Int],
...
case class CreateTransparentCommonExtraColumnAction(relationId: Int, extraColumnVariable: Variable,
                                                    joinKeyIndices: List[Int]) extends ReduceAction
case class CreateComparisonExtraColumnAction(relationId: Int, extraColumnVariable: Variable, joinKeyIndices: List[Int],
                                             compareKeyIndex1: Int, compareKeyIndex2: Int, func1: String,
                                             func2: String) extends ReduceAction
case class CreateComputationExtraColumnAction(relationId: Int, columnVariable: Variable, keyIndices: List[Int],
...
case class AppendCommonExtraColumnAction(relationId: Int, extraColumnVariable: Variable,
                                         joinKeyIndices: List[Int]) extends ReduceAction
case class AppendComparisonExtraColumnAction(relationId: Int, extraColumnVariable: Variable, joinKeyIndices: List[Int],
                                             compareKeyIndex: Int, func: String) extends ReduceAction
case class ApplySemiJoinAction(currentRelationId: Int, childRelationId: Int, joinKeyIndicesInCurrent: List[Int],
                               joinKeyIndicesInChild: List[Int]) extends ReduceAction
case class ApplySelfComparisonAction(relationId: Int, keyIndices: List[Int],
                                     functionGenerator: String => String) extends ReduceAction
case class EndOfReductionAction(relationId: Int) extends ReduceAction

sealed trait EnumerateAction
case class RootPrepareEnumerationAction(relationId: Int, joinKeyIndices: List[Int],
                                        extractIndicesInCurrent: List[Int]) extends EnumerateAction
case class EnumerateWithoutComparisonAction(relationId: Int, joinKeyIndicesInCurrent: List[Int],
                                            extractIndicesInCurrent: List[Int],
                                            extractIndicesInIntermediateResult: List[Int],
                                            optResultKeyIsInIntermediateResultAndIndices: Option[List[(Boolean, Int)]]
                                           ) extends EnumerateAction
case class EnumerateWithOneComparisonAction(relationId: Int, joinKeyIndicesInCurrent: List[Int],
                                            compareKeyIndexInCurrent: Int, compareKeyIndexInIntermediateResult: Int,
                                            func: String, extractIndicesInCurrent: List[Int],
                                            extractIndicesInIntermediateResult: List[Int],
                                            optResultKeyIsInIntermediateResultAndIndices: Option[List[(Boolean, Int)]]
                                           ) extends EnumerateAction
case class EnumerateWithTwoComparisonsAction(relationId: Int, joinKeyIndicesInCurrent: List[Int],
